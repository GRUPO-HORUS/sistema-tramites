...
//    Route::get('/terminos-y-condiciones', 'HomeController@terminosFront')->name('front.terminos');
    ...
    Route::get('/documentos/firma_get', 'DocumentController@firma_get');
    Route::post('/documentos/firma_post', 'DocumentController@firma_post');
...
Route::prefix('backend')->namespace('Backend')->name('backend.')->group(function () {
    ...
    Route::post('/configuracion/autoregistro/usuario_editar', 'ConfigurationController@storeFrontendUsersAutoregistro');
