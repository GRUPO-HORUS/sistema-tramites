...
@section('content')
	...
	<tr>
			@foreach($pasosEjecutables as $i=>$p)
				@if ($i==$secuencia)
					<td style="color: white; background-color: #001C54; text-align:center; border-top-color: #d8d8d8; border-bottom-color: #d8d8d8; border-top-style: solid; border-bottom-style: solid; font-family: Arial;">
				@else
					<td style="background-color: #e7e7e7; text-align:center; border-top-color: #d8d8d8; border-bottom-color: #d8d8d8; border-top-style: solid; border-bottom-style: solid; font-family: Arial;">
				@endif
					{{$i+1}}
					<br>
					{{$p->Formulario->nombre}}
				...
				@if ($i<$num_pasos-1)
						@if ($i==$secuencia)
							<td style="padding:0px; background-color: #e7e7e7; border-top-color: #d8d8d8; border-bottom-color: #d8d8d8; border-top-style: solid; border-bottom-style: solid;">
							<img src="/images/blue-to-gray.jpg">
						@elseif ($i+1==$secuencia)
							<td style="padding:0px; background-color: #001C54; border-top-color: #d8d8d8; border-bottom-color: #d8d8d8; border-top-style: solid; border-bottom-style: solid;">
							<img src="/images/gray-to-blue.jpg">
						@else
							<td style="padding:0px; background-color: #e7e7e7; border-top-color: #d8d8d8; border-bottom-color: #d8d8d8; border-top-style: solid; border-bottom-style: solid;">
							<img src="/images/gray-to-gray.jpg">
						@endif
					</td>
				@endif
			@endforeach
	...
	<fieldset style="border: 1px solid; padding: 40px;">
	<legend style="width: auto; font-family: arial;">{{$paso->Formulario->nombre}}</legend>
        <hr>
        <?php
            $campos_dependientes = [];
        ...
        <div class="form-actions mt-3 simple-btn-actions">
            ...
            @else
                ...
                @endif
                <button class="btn" style="background-color:#001C54; color:white;" type="submit">Siguiente <span class="material-icons" style="font-size: smaller;">
arrow_forward_ios
</span></button>
            @endif        
        </div>            
