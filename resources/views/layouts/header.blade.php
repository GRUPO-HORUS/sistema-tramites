<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container" style="background-color: rgb(0,28,84); min-width:100%;">
        <a class="" href="{{ url('/') }}">
            <div class="media">
                ...
                @if (Auth::guest() || !Auth::user()->registrado)
                    <li class="nav-item login-default mr-3">
                        <a href="{{route('login')}}" class="nav-link">
                            Ingresar sin Identidad Electrónica
                        </a>
                    </li>
                    <li class="nav-item login">
                        <a href="{{route('login.claveunica')}}" class="nav-link">
	                            <span class="material-icons" style="vertical-align: -6px;">account_circle</span> {{__('auth.login_claveunica')}}
                        </a>
                    </li>
                @else
                    <li class="nav-item dropdown login">
                        <a href="#" class="nav-link dropdown-toggle" id="navbarDropdownMenuLink"
                           ...
                           aria-haspopup="true" aria-expanded="false">
                            <span class="material-icons">account_circle</span> Bienvenido/a, {{ Auth::user()->nombres }}
                        </a>
