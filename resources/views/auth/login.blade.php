                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <button type="submit" class="btn btn-login btn-danger float-right" style="background-color: #00a99b;">
                                        {{__('auth.enter')}}
                                    </button>
                                </div>
                            </div>
...
<div class="form-group row">
  <div class="col-md-6 offset-md-3">
    <a href="{{ route('login.claveunica') }}" class="btn btn-danger btn-block font-weight-bold" style="background-color: #00a99b;">
