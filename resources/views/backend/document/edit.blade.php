    ...
    <div class="container-fluid mt-3">
        ...
        <form class="ajaxForm" method="POST"
            ...
            <fieldset>
				...
				<div class="form-check">
                    <input type="radio" name="tipo" class="form-check-input" id="tipo_certificado"
                           value="certificado_carnet_qr" <?= $edit && $documento->tipo == 'certificado_carnet_qr' ? 'checked' : '' ?> />
                    <label for="tipo_certificado" class="form-check-label">
                        Certificado Carnet QR
                    </label>
                </div>
                </label>
				...
				<div class="form-check">
                    <input type="radio" name="tamano" class="form-check-input" id="tamano_a4"
                           value="A4" <?= !$edit || ($edit && $documento->tamano == 'A4' ) ? 'checked' : '' ?> />
                    <label for="tamano_a4" class="form-check-label">A4</label>
                </div>
				<div class="form-check">
                    <input type="radio" name="tamano" class="form-check-input" id="tamano_carnetAntsv"
                           value="carnetAntsv" <?= !$edit || ($edit && $documento->tamano == 'carnetAntsv' ) ? 'checked' : '' ?> />
                    <label for="tamano_carnetAntsv" class="form-check-label">Carnet Antsv (8.5x5.5)</label>
                </div>
