    ...
    public function asignar($usuario_id)
    {
        ...
        if ($this->Tarea->asignacion_notificar) {
            ...
            if ($usuario->email) {
               ...
               <div style="text-indent:40px;line-height:0px"></div>
                 ...
                 <div style="text-indent:40px;text-align:justify;font-family: Roboto, sans-serif;font-size: 16px;line-height: 24px;"><b> '.$this->Tarea->nombre.'</b> en Trámites ANTSV. </div>
