...
class ConfigurationController extends Controller
{
    ...
    public function saveFrontendUsersAutoregistro(Request $request, User $user, $edit = false)
    {
        $validations = [
            'nombres' => 'required',
            'email' => 'required|email|min:6|max:128',
    ...
    public function storeFrontendUsersAutoregistro(Request $request)
    {
        $this->saveFrontendUsersAutoregistro($request, new User());

        return response()->json(array('mensaje' => 'Usuario creado con éxito'));
    }  
}
