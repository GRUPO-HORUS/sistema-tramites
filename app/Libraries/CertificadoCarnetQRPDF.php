...
class CertificadoCarnetQRPDF extends TCPDF
{
    public $id = '123456789';
    ...
    public $copia = false;
    public $content = '';
	public $logo2 = 'assets/img/certificados/logo_gobierno-chile.png';
	public $carnet = 'assets/img/certificados/logo_gobierno-chile.png';
	public $content2 = '';
    ...
    public function Content()
    {
        ...
        $this->Image($this->logo, 40, PAGE_MARGIN, CELL_WIDTH, 30, '', '', 'T', true, 300, '', false, false, 0, true);
	$this->Image($this->timbre, 135, PAGE_MARGIN, CELL_WIDTH, 30, '', '', 'T', true, 300, '', false, false, 0, true);

	$this->StartTransform();
	$this->StarPolygon(103, 72, 18, 90, 3, 0, 1, 'CNZ');
	$this->Image($this->logo, 85, 50, 50, 50, '', '', 'T', true, 300, '', false, false, 0, true);
	$this->StopTransform();

	$this->SetX(PAGE_MARGIN);
	...
	$this->write2DBarcode(url('validador/documento?id=' . $this->id . '&key=' . $this->key), 'QRCODE,H', 75, 50, 50, 50);
	$this->SetX(PAGE_MARGIN);
	$this->SetY($this->GetY()+50);
